/**
 * @ingroup     boards_cgmfs
 * @{
 *
 * @file
 * @brief       Peripheral MCU configuration for the cgmfs board
 *
 ...
 * @{
 */
static const timer_conf_t timer_config[] = {{.dev = TIM5,
                                             .max = 0xffffffff,
 ...
 * @brief uart connetced to expansion port
 * @{
 */
...
static const spi_conf_t spi_config[] = {{.dev = SPI3,
